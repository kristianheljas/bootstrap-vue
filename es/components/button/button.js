...
function computeClass(props) {
  ...
  return [props.variant ? 'btn-' + props.variant : 'btn-secondary', (_ref = {}, _defineProperty(_ref, 'btn-' + props.size, Boolean(props.size)), _defineProperty(_ref, 'btn-block', props.block), _defineProperty(_ref, 'disabled', props.disabled), _defineProperty(_ref, 'active', props.pressed), _ref)];
}
